  ...
  const games = [
    {
      ...
      title: 'Classic 3x3',
      description: 'Traditional tic-tac-toe with 3x3 grid. Get 3 in a row to win.',
      icon: Grid3X3,
      difficulty: 'Easy',
      players: '2 Players'
    },
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="text-center mb-12">
        <h2 className="text-3xl font-bold mb-4 dark:text-slate-100">Choose Your Game</h2>
              ...
              <div className="flex justify-between items-center pt-4 border-t border-slate-100 dark:border-slate-700">
                <div className="flex gap-4 text-xs">
                  <span className={`px-2 py-1 rounded-full font-medium ${
                    ...
                    game.difficulty === 'Hard' ? 'bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400' :
